...
$l['setting_gomobile_theme_id_desc'] = "Enter a comma separated list of tids (Theme IDs) that can be used with GoMobile below. This is used to switch the user to the mobile version. The first tid is used as a default";
...
$l['gomobile_mobile_style'] = "Mobile board style";
...
$l['newpm_notice_one'] = "One unread PM: <a href=\"{2}/private.php?action=read&amp;pmid={3}\" style=\"font-weight:bold;\">{4}</a> by {1}";
$l['newpm_notice_multiple'] = "{1} unread PMs. Newest: <a href=\"{3}/private.php?action=read&amp;pmid={4}\" style=\"font-weight:bold;\">{5}</a> by {2}";
